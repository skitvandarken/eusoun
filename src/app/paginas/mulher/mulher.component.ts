...
export class MulherComponent {
  ...
  readonly allNames = [
    ...
    { name: 'Elizabeth Francisco', photo: 'img/mulheres/enhaced/elizabeht-Picsart-AiImageEnhancer.jpg' },
    { name: 'Elizandra Companhia', photo: 'img/mulheres/enhaced/elizandra-Picsart-AiImageEnhancer.jpg' },
